...
<head>
    ...
    <style>
        ...
        .background-blur {
            ...
            height: 100vh;
            width: 100vw;
            background: url('image/PU_GATE_COVER_IMAGE.png') no-repeat center center;
        ...
        @media (max-width: 768px) {
            body {
                overflow: auto; /* allow page to scroll on small screens */
            }
            .main-content {
                height: auto; /* remove fixed viewport locking */
                min-height: 100vh;
                align-items: flex-start; /* stack from top */
                padding-top: 80px; /* keep space for navbar */
            }
            .content-wrapper {
                flex-direction: column;
                gap: 30px;
        ...
        @media (max-width: 480px) {
            body {
                overflow: auto; /* ensure scrollability on very small screens */
            }
            .main-content {
                height: auto;
                min-height: 100vh;
                align-items: flex-start;
                padding-top: 60px; /* slightly tighter for smaller navbar spacing */
            }
...
<script>
    ...
    // Google OAuth is now handled server-side via redirect
</script>
