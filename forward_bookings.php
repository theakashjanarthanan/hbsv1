                ...
                <div class="card-body">
                        ...
                        <?php if ($filterApplied): ?>
                            <div class="clear-filters">
                                <a href="forward_bookings.php" class="btn btn-danger"><i class="fa-solid fa-broom"></i> Clear Filters</a>
                            </div>
                        <?php endif; ?>
                        <tr>
                            <th width="10%">
                                    ...
                                    <td>
                                        <form action="forward_bookings.php" method="post" style="display:inline;">
                                            ...
                                            <button type="submit" name="new_status" value="pending"
                                                class="btn btn-outline-success mt-2"><i class="fa-solid fa-paper-plane"></i> <b>Forward</b></button>
    ...
    <script>
        ...
        document.querySelectorAll("#bookedDateFilterForm, #hallFilterForm, #purposeFilterForm, #dateRangeFilterForm, #organiserFilterForm, #statusFilterForm").forEach(form => {
                    form.onsubmit = function (event) {
                        ...
                        let queryString = new URLSearchParams(url.search);
                        ...
                        // Redirect with updated query string on the current page
        ...
        function clearAllFilters() {
            // Clear all query params and stay on the same page
            let url = new URL(window.location.href);
            url.search = '';
            window.location.href = url.toString();
        }
