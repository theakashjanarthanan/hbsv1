...
?>
     <tr>
                                        ...
                                        <td>
                                            ...
                                            sort($booked_slots);
                                            $all_slots = array_unique(explode(',', $row['slot_or_session']));
                                            sort($all_slots);
                                      ...
                                      <?php
                                            if (!empty($row['event_type'])) {
                                                echo '<br><span style="color:blue;">' . ucwords(str_replace('_', ' / ', $row['event_type'])) . '</span>';
                                            }
                                            echo "<br>".$row['purpose_name']."<br>";
...
<td>                                            <?php
                                        ...
                                        <td>
                                            <form action="no_conflict_bookings.php" method="post" style="display:inline;">
