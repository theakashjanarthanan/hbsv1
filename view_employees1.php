                                    ...
                                    <?php if (mysqli_num_rows($result) > 0):
                                        ...
                                        while ($employee = mysqli_fetch_assoc($result)): ?>
                                            <tr>
                                                ...
                                                <td style="width:12%;">
                                                    <input type="checkbox" style="width: 20px; height: 20px; margin: 30% 30%;"
                                                        class="hall-checkbox" value="<?php echo $employee['employee_id']; ?>"
                                                        onclick="handleCheckbox(this)">
                                                </td>
                                                <td style="width:18%; "><b
                                                        style="color: #007bff;"><?php echo htmlspecialchars($employee['employee_name']); ?></b><br>
                                                    <?php echo htmlspecialchars($employee['employee_email']); ?><br>
                                                    <?php echo htmlspecialchars($employee['employee_mobile']); ?> </td>
                                                <td style="width:12%;"><?php echo htmlspecialchars($employee['designation']); ?>
                                                </td>
                                                <td style="width:24%;"> <b
                                                        style="color: #007bff;"><?php echo htmlspecialchars($employee['office']); ?></b><br>
                                                    <?php echo htmlspecialchars($employee['department_name']); ?></td>
